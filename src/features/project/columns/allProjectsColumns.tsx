...
export const allProjectColumns = ({ onView }: ProjectColumnProps): ColumnDef<Project>[] => [
  {
    header: 'Client Name',
    accessorFn: (row: Project) => row.client?.name || '-',
    id: 'client_name',
    size: 250,
    cell: (info) => (
  ...
  },
  {
    ...
    header: 'Actions',
    size: 140,
    cell: (info) => <TableActions onView={() => onView(info.row.original)} />,
  },
];
